  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className="sm:text-lg cursor-pointer hover:scale-105 transition-all duration-200 text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full"
